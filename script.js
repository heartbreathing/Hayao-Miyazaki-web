...
function addText () {
  ...
  textElement.innerText = 'The Animation World of Hayao Miyazaki'; 
  textElement.classList.add('custom-font'); 
...
function placeImage (transitionIn) {
  ...
  if (transitionIn !== false) {
    TweenMax.fromTo(image, 0.75, { z: -500 }, { z: 0, ease: Cubic.easeOut }); 
  }
...
function playClickSound () {
  clickSound.currentTime = 0; // Reset the audio playback time to the starting position
  clickSound.play();
}
